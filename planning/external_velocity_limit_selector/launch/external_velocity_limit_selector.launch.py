...
def generate_launch_description():
    ...
    external_velocity_limit_selector_node = Node(
        ...
        output="screen",
        remappings=[
            ("input/velocity_limit_from_api", LaunchConfiguration("input_velocity_limit_from_api")),
            ("input/velocity_limit_from_internal", LaunchConfiguration("input_velocity_limit_from_internal")),
            ("input/velocity_limit_clear_command_from_internal",
             LaunchConfiguration("input_velocity_limit_clear_command_from_internal")),
            ("output/external_velocity_limit", LaunchConfiguration("output_velocity_limit_from_selector")),
